...
def lex(file_input):
    ...
    while i < len(content):
        ...
        # Inside your lex() function in lexer.py
        ...
        if char in operators:
            ...
            tokens.append((f'tk_op_{lexeme}', lexeme, line_num, column_num))  # Add column and line info here
            column_num += (i - start)
            continue

        # Delimitadores
        if char in delimiters:
            tokens.append((f'tk_delim_{char}', char, line_num, column_num))  # Include line and column info
            column_num += 1
            i += 1
            continue
